...
/*   Updated: 2026/05/21 16:40:01 by schappuy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// ray_basing.c
void				base_position(char **map, t_ray *ray, float deg,
						float *position);
...
// corner_cases.c
int					is_corner(char **map, t_ray *ray, int *int_pos,
						float *posi);
...
int					is_small_corner(char **map, t_ray *ray, int *int_pos,
						float *posi);
