...
u_int32_t	color_from_texture(mlx_texture_t *texture, int *spot,
	uint8_t *colors)
{
	uint32_t	color;
...
uint32_t	get_south_north_color(t_cube *game, t_ray *ray, int *borders,
	int place)
{
	...
	return (color_from_texture(texture, spot, colors));
}
